...
$incrementB =5;
$increment=[
  "pós-incrementos" => $incrementA++,
  "res-incrementos" => $incrementA,
  "pre-incrementos" => ++$incrementA,
  "pós-decrementos" => $incrementB--,
  "res-decrementos" => $incrementB,
  "pre-decrementos" => --$incrementB
];
var_dump($increment);
...
$logic = [
  ...
  "a || b" => ($logicA || $logicB),// existe A ou  B ?
  "a" => ($logicA),//existe A ?
  "!b" => (!$logicB)//Não existe A ?
];
var_dump($logic);
/**
