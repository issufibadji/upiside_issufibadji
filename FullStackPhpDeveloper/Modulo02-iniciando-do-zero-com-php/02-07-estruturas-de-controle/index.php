...
fullStackPHPClassSession("if, elseif, else", __LINE__);
    ...
    if($year == 2022 ){
     ...
     var_dump("Ano posterior");
    }else{
      var_dump("Ano Anterior");
    };
/*
...
fullStackPHPClassSession("switch", __LINE__);
    ...
    switch ($payment) {
        case "billet_printed"://se for billet_printed excuta codigo
            var_dump("Boleto Impresso");
            break;//pare
        case 'canceled':
            var_dump("Pagamento Cancelado");
            break;
        case 'past_due': //se for past_due/pending excuta codigo
        case 'pending':
        ...
        case 'completed':
            ...
            break;
        default://se não executar nenhuma das condição 
