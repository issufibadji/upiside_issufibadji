...
//Funcão anonima//é valida só neste momento
    $myAge = function ($year) {
        $age = date("Y") - $year;
...
//exmplo da função da carinha de compra
    $myCart = [];
    $myCart["totalPrice"] = 0;
...
//Percisa de muita memoria caso for grande dados
$iterator = 365; //4000000
...
//Recomendados para percorrer uma tabela com muitos dados
